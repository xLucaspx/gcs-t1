...
/**
 * Classe ItemHandler é responsável por gerenciar uma lista de objetos do tipo Item.
 * Ela permite adicionar, remover e buscar itens na lista com base em diferentes critérios,
 * como ID, nome, descrição e categoria.
 */
public class ItemHandler {
     ...
     * @return true se o item foi adicionado com sucesso, false se o item é nulo.
     */
     ...
     * @return O item correspondente ao ID fornecido, ou null se não for encontrado.
     */
     ...
     * @return O item correspondente ao nome fornecido, ou null se não for encontrado.
     */
